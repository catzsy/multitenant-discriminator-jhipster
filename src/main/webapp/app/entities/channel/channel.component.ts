...
export class ChannelComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.channelService
      ...
      .subscribe(
        (res: HttpResponse<IChannel[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInChannels(): void {
    this.eventSubscriber = this.eventManager.subscribe('channelListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IChannel[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
