...
/**
 * REST controller for managing {@link com.example.demo.domain.Tenant}.
 */
@RestController
@RequestMapping("/api")
public class TenantResource {
    ...
    public ResponseEntity<TenantDTO> updateTenant(@Valid @RequestBody TenantDTO tenantDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tenantDTO.getId().toString()))
            .body(result);
    }
