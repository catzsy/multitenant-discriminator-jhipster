...
import com.example.demo.config.audit.AuditEventConverter;
import com.example.demo.domain.PersistentAuditEvent;
...
import static com.example.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
